...
TEST_CASE_TEMPLATE("Vector triple product", Type, VALID_TYPES) {
    ...
    constexpr auto v1 = getVec<Type, 3>(kInput1);
    constexpr auto v2 = getVec<Type, 3>(kInput2);
    constexpr auto v3 = getVec<Type, 3>(kInput3);

    // Only defined for 3D vectors
    CHECK(vector_triple(v1, v2, v3) == getVec<Type, 3>(kExpected));
}
...
TEST_CASE_TEMPLATE("Project onto", Type, VALID_TYPES) {
    ...
    SUBCASE("2D") {
        ...
        CHECK(v1_proj_v2 == getVec<Type, 2>(kExpected));
    }
    ...
    SUBCASE("3D") {
        ...
        CHECK(v1_proj_v2 == getVec<Type, 3>(kExpected));
    }
    ...
    SUBCASE("4D") {
        ...
        CHECK(v1_proj_v2 == getVec<Type, 4>(kExpected));
    }
}
...
TEST_CASE_TEMPLATE("Project onto unit", Type, VALID_TYPES) {
    ...
    SUBCASE("2D") {
        ...
        CHECK(v1_proj_unit_v2 == getVec<Type, 2>(kExpected));
    }
    ...
    SUBCASE("3D") {
        ...
        CHECK(v1_proj_unit_v2 == getVec<Type, 3>(kExpected));
    }
    ...
    SUBCASE("4D") {
        ...
        CHECK(v1_proj_unit_v2 == getVec<Type, 4>(kExpected));
    }
}
...
TEST_CASE_TEMPLATE("Reject from", Type, VALID_TYPES) {
    ...
    SUBCASE("2D") {
        ...
        CHECK(v1_rej_v2 == getVec<Type, 2>(kExpected));
    }
    ...
    SUBCASE("3D") {
        ...
        CHECK(v1_rej_v2 == getVec<Type, 3>(kExpected));
    }
    ...
    SUBCASE("4D") {
        ...
        CHECK(v1_rej_v2 == getVec<Type, 4>(kExpected));
    }
}
...
TEST_CASE_TEMPLATE("Reject from unit", Type, VALID_TYPES) {
    ...
    SUBCASE("2D") {
        ...
        CHECK(v1_rej_unit_v2 == getVec<Type, 2>(kExpected));
    }
    ...
    SUBCASE("3D") {
        ...
        CHECK(v1_rej_unit_v2 == getVec<Type, 3>(kExpected));
    }
    ...
    SUBCASE("4D") {
        ...
        CHECK(v1_rej_unit_v2 == getVec<Type, 4>(kExpected));
    }
}
