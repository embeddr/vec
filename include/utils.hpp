...
bool floating_point_eq(Type a, Type b) {
    ...
    static constexpr Type abs_threshold = std::numeric_limits<Type>::min();
    ...
    static_assert(epsilon < static_cast<Type>(1),
            "Provided template parameter abs threshold must be >= 1");
...
// TODO: Fixed and floating point constexpr sqrt()/abs() implementations
